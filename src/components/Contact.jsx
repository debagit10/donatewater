    ...
    return (
        ...
        <div className="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="bg-[#76c0d0] border border-[#cd0046] w-full lg:w-1/2 h-full p-5 pt-8">
                ...
                <a href="https://twitter.com/WaterDonate" className="flex items-center hover:text-white hover:bg-[#cd0046] p-2">
                <svg  viewBox="0 0 50 50" 
                    fill="currentColor" className="w-10 h-10 m-2" xmlns="http://www.w3.org/2000/svg"><path d="M39.2 16.8c-1.1.5-2.2.8-3.5 1 1.2-.8 2.2-1.9 2.7-3.3-1.2.7-2.5 1.2-3.8 1.5-1.1-1.2-2.7-1.9-4.4-1.9-3.3 0-6.1 2.7-6.1 6.1 0 .5.1.9.2 1.4-5-.2-9.5-2.7-12.5-6.3-.5.7-.8 1.7-.8 2.8 0 2.1 1.1 4 2.7 5-1 0-1.9-.3-2.7-.8v.1c0 2.9 2.1 5.4 4.9 5.9-.5.1-1 .2-1.6.2-.4 0-.8 0-1.1-.1.8 2.4 3 4.2 5.7 4.2-2.1 1.6-4.7 2.6-7.5 2.6-.5 0-1 0-1.4-.1 2.4 1.9 5.6 2.9 9 2.9 11.1 0 17.2-9.2 17.2-17.2V20c1.2-.9 2.2-1.9 3-3.2z"/>
                </svg>
                    Twitter
                </a>
                <a href="https://www.linkedin.com/company/donatewater/" className="flex items-center hover:text-white hover:bg-[#cd0046] p-2">
                ...
                <a href="#" className="flex items-center hover:text-white hover:bg-[#cd0046] p-2">
                ...
                <a href="https://www.facebook.com/profile.php?id=100069924513582&mibextid=ZbWKwL" className="flex items-center hover:text-white hover:bg-[#cd0046] p-2">
                    <svg fill="currentColor" className="w-6 h-6 m-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
            ...
            <form action="#" className="w-full md:w-1/2 border border-[#cd0046] p-6 bg-white">
            ...
            <div className="w-full pt-3">
                <button type="submit" className="w-full bg-[#3aadc4] border border-[#cd0046] px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-[#cd0046] hover:text-white text-xl cursor-pointer">
                Send
                </button>
            </div>
            </form>
